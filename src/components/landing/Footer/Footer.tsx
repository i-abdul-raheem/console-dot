...
import { AddressInfo, ContactInfo, ContactSection, EmailInfo, FooterBottom, FooterHeading, FooterSection, NavItem, NavItemList, NavSection, ReviewSection, WhatsAppInfo, SocialMediaIconsList ,FooterBottomCopyRight } from "./elements";
export const Footer = () => {
  return (
    <>
    <FooterSection>
